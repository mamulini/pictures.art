...
var checkTextInputs = function checkTextInputs(selector) {
  var textInput = document.querySelectorAll(selector);
...
var filter = function filter() {
  var menu = document.querySelector('.portfolio-menu'),
      ...
      btnGrandded = menu.querySelector('.granddad'),
      wrapper = document.querySelector('.portfolio-wrapper'),
      markAll = wrapper.querySelectorAll('.all'),
      markGirl = wrapper.querySelectorAll('.girl'),
      markGuy = wrapper.querySelectorAll('.guy'),
      markChef = wrapper.querySelectorAll('.chef'),
      markLover = wrapper.querySelectorAll('.lovers'),
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  function createCards(response) {
    response.forEach(function (_ref) {
      ...
      card.innerHTML = "<div class=\"styles-block\" >\n                                <img src=".concat(src, " alt=\"image\">\n                                <h4>").concat(title, "</h4>\n                                <a href=").concat(link, ">\u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435</a>\n                              </div>");
      document.querySelector(wrapper).appendChild(card);
    });
  }
};

/* harmony default export */ __webpack_exports__["default"] = (showMoreStyles); // cards.forEach(card => {
